                        ...
                        <div className="col-lg-12">
                            ...
                            <div className="title-area-multiple-elements">
                                <div className="title-left-style-two">
                                    ...
                                    <h2 className="title">
                                        Facultad de Arquitectura y <br/>Diseño de Interiores
                                    </h2>
                                </div>
                                <p className="disc">
                                ...
                                <div className="body">
                                    <div className="wrapper">
                                        ...
                                        <div className="inner">
                                            ...
                                            <p className="disc">
                                            Descripción de la opción jerarquica de segundo nivel a promocionar.
                                            </p>
                                            <Link
                                                href="/service-details"
                                                className="arrow-btn-read-more"
                                ...
                                <div className="body">
                                    <div className="wrapper">
                                        ...
                                        <div className="inner">
                                            ...
                                            <p className="disc">
                                            Descripción de la opción jerarquica de tercer nivel a promocionar.
                                            </p>
                                            <Link
                                                href="/service-details"
                                                className="arrow-btn-read-more"
